...
export default function Faqs() {
  return (
    <section className="w-4/5 m-auto">
      <h2 className="text-5xl text-center m-12">PREGUNTAS FRECUENTES</h2>
      <section className="flex flex-wrap flex-col justify-center p-4 rounded-lg w-auto md:w-4/5 m-auto">
        <Accordion>
          ...
          >
            ...
            jabón, le recomendamos una pequeña cantidad de detergente para ropa
            o quitamanchas. Frote o cepille la mancha, enjuague. Deje que la
            alfombrilla de ratón se seque al aire y debería quedar como nueva.
            Intentamos usar una lavadora en un entorno delicado con nuestras
            alfombrillas para mouse y salió genial. Dicho esto, no podemos
            garantizar que todas las lavadoras tengan el mismo gran resultado,
            por lo que no podemos garantizar que la almohadilla mantenga la
            misma consistencia.
          </AccordionItem>
          <AccordionItem
            key="5"
          ...
          >
            ...
            support@magicbyzeko.com y háganos saber que le gustaría realizar un
            pedido de 10 o más alfombrillas para mouse personalizadas.
          </AccordionItem>
          <AccordionItem
            key="6"
          ...
          >
            ...
            aplica en casos en los que el producto haya tenido una falla tecnica
            de fabrica, no aplica en casos que por algun motivo se derrame
            liquido, hayan lavado el producto de manera inapropiada. Si deseas
            aplicar garantia debes escribirnos a garantia@magicbyzeko.uno
          </AccordionItem>
        </Accordion>
      </section>
    </section>
